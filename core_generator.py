...
# --- (Las funciones auxiliares como refine_and_shorten, etc. no cambian) ---
def refine_and_shorten_tweet(tweet_text: str, model: str) -> str:
    ...
    except Exception as e: return tweet_text
...
def generate_tweet_from_topic(topic_abstract: str):
    ...
    for attempt in range(MAX_ATTEMPTS):
        # ... (el resto del bucle de generación no cambia) ...
        ...
        try:
            ...
            print("🧠 Enviando prompt a Claude 3.5 Sonnet...")
    ...
    return "Error: No se pudo generar un borrador válido.", ""


def find_relevant_topic():
    # MODIFICADO: Obtenemos la colección de temas aquí
...
def find_topic_by_id(topic_id: str):
    ...
    try:
        ...
        pass
    # ... (el resto del fallback a JSON no cambia) ...
